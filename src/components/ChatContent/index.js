...
export const chatContent = (chatInfo) => {
    const {id, name, lastMessage, unreadCount} = chatInfo
    return(`
        <section class=${styles.chatContent}>
            <div class=${styles.top}>
                ...
                `<svg width="3" height="16" viewBox="0 0 3 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        styles.chatBtn, 'button', '', 'Действия с чатом'
                )}
            </div>
            ...
            <div class=${styles.foot}>
                ${button(
                    ...
                    styles.chatBtn, 'button', '', 'Прикрепить файл'
                )}
                ${form(input(styles.input, 'message', 'text', null, null, 'Сообщение'), styles.messageForm)}
                ${button(
                    ...
                    null, 'button', '', 'Отправить сообщение'
                )}
            </div>
        </section>
    `)
